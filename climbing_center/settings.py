...
SECRET_KEY = env("DJANGO_SECRET_KEY", default='django-insecure-&db*t*&_s=6%z6d%z9@0as0^6(v#%4f61!mu-c54&f@fgc%$uv')
...
AUTH_USER_MODEL = 'service.Instructor'
...
WSGI_APPLICATION = 'climbing_center.wsgi.application'
